...
# https://www.coursera.org/learn/data-structures/discussions/forums/3RROFuagEea_9gojxtuxKA/threads/lwor4nEnEemZEAp2MmJyTg
...
def test():
    ...
    path = os.getcwd()+'/test_utils/3_network_simulation/tests'
